...
User.create(username:Faker::Name.name, email: "me@you.com", password: "12345")
User.create(username:Faker::Name.name, email: "you@me.com", password: "098765")
User.create(username:Faker::Name.name, email: "sis@woo.com", password: "qweasd")
